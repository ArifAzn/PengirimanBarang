                                            ...
                                            <div class="modal-body">
                                                <form method="POST">
                                                    <div class="text-center">
                                                        ...
                                                        <div class="text-end">
                                                            <button type="submit" class="btn btn-danger" name="deleteus">
                                            ...
                                            <form method="POST" action="koneksi.php">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="last_name" id="lsnameInput<?php echo $id_user; ?>" class="form-control" value="<?php echo $last_name; ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="role" id="roleInput<?php echo $id_user; ?>" class="form-control" required>
                                                            ...
                                                            <option value="pelanggan" <?php if ($role == 'pelanggan') echo 'selected'; ?>>Pelanggan</option>
                                                        </select>
                                                    </div>
                ...
                <form method="POST" action="koneksi.php">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="last_name" id="lsnameInput" class="form-control" placeholder="Last Name">
                        </div>
