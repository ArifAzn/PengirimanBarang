...
if (isset($_POST['addnewpgrm'])) {
    ...
    $addtopengiriman = "INSERT INTO pengiriman (tanggal, id_pelanggan, id_kurir, id_barang, Penerima, AlamatTujuan, BeratBarang, JenisPengiriman, TotalHarga, KategoriPengiriman, Status) 
                        VALUES ('$tanggal', '$id_pelanggan', '$id_kurir', '$id_barang', '$penerima', '$alamat_tujuan', '$berat_barang', '$jenis_pengiriman', '$total_harga', '$kategori_pengiriman', '$status')";
